...
export const BridgeIn = ({ data }: Props) => {
  ...
  return (
    <>
      ...
      <TvlDiv>
        <TimeChartMaker
          title="Daily USD volume Bridged In"
          grp={grp}
          key_name={"usd_vol"}
        />
        <TimeChartMaker
          title="Daily Bridge In transactions"
          grp={grp}
          key_name={"txs"}
          chart={"Bar"}
        />
        <TimeChartMaker
          title="Daily USD volume lost by Bridging Users"
          grp={grp}
          key_name={"lost_usd_vol"}
          chart={"Bar"}
        />
        <TimeChartMaker
          title="Daily Fees paid by Users"
          grp={grp}
          key_name={"fees_usd"}
        />
      </TvlDiv>
